...
* Update get avatar from assets(Android), thanks @Ricky-yu
* Add `isAccepted` properties for iOS and only show facetime button if support video, thank @td2thinh
* Fixed some bugs.

## 2.5.2
* Add notification calling for Android `callingNotification`, thank @ebsangam
* Add `logoUrl` properties (inside android prop)
* Fixed issue DMTF IOS, thank @minn-ee
