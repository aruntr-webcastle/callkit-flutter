...
class CallkitNotificationManager(
    ...
    private val callkitSoundPlayerManager: CallkitSoundPlayerManager? = null
) {
    ...
    fun createNotificationChanel(data: Bundle) {
        createNotificationChanel(
            data.getString(CallkitConstants.EXTRA_CALLKIT_INCOMING_CALL_NOTIFICATION_CHANNEL_NAME, "Incoming Call"),
            data.getString(CallkitConstants.EXTRA_CALLKIT_MISSED_CALL_NOTIFICATION_CHANNEL_NAME, "Missed Call"),
            data.getString(CallkitConstants.EXTRA_CALLKIT_ONGOING_CALL_NOTIFICATION_CHANNEL_NAME, "Ongoing Call")
        )
    }
    ...
    private fun createNotificationChanel(
        ...
        createNotificationChanel(incomingCallChannelName, missedCallChannelName, "Ongoing Call")
    }

    private fun createNotificationChanel(
        incomingCallChannelName: String,
        missedCallChannelName: String,
        ongoingCallChannelName: String = "Ongoing Call"
    ) {
    ...
    @SuppressLint("MissingPermission")
    fun getOnGoingCallNotification(data: Bundle, isConnected: Boolean? = false): CallkitNotification? {
        val onGoingNotificationId = ("ongoing_" + data.getString(CallkitConstants.EXTRA_CALLKIT_ID, "callkit_incoming")).hashCode()
        createNotificationChanel(
            data.getString(CallkitConstants.EXTRA_CALLKIT_INCOMING_CALL_NOTIFICATION_CHANNEL_NAME, "Incoming Call"),
            data.getString(CallkitConstants.EXTRA_CALLKIT_MISSED_CALL_NOTIFICATION_CHANNEL_NAME, "Missed Call"),
            data.getString(CallkitConstants.EXTRA_CALLKIT_ONGOING_CALL_NOTIFICATION_CHANNEL_NAME, "Ongoing Call")
        )
        val builder = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID_ONGOING)
            .setChannelId(NOTIFICATION_CHANNEL_ID_ONGOING)
            .setContentTitle(data.getString(CallkitConstants.EXTRA_CALLKIT_NAME_CALLER, ""))
            .setContentText(data.getString(CallkitConstants.EXTRA_CALLKIT_HANDLE, ""))
            .setOngoing(true)
            .setAutoCancel(false)
            .setSound(null)
            .setSmallIcon(R.drawable.ic_accept)
        val hangupIntent = CallkitIncomingBroadcastReceiver.getIntentEnded(context, data)
        builder.setContentIntent(PendingIntent.getBroadcast(context, onGoingNotificationId, hangupIntent, getFlagPendingIntent()))
        return CallkitNotification(onGoingNotificationId, builder.build())
    }

    @SuppressLint("MissingPermission")
    fun showOngoingCallNotification(data: Bundle, isConnected: Boolean?) {
        getOnGoingCallNotification(data, isConnected)?.let {
