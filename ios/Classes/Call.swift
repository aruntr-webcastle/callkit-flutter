...
@objc public class Data: NSObject {
    ...
    @objc public init( id: String,
                       ...
                       audioSessionActive: Bool = true,
                       audioSessionPreferredSampleRate: Double = 44100.0,
                       audioSessionPreferredIOBufferDuration: Double = 0.005) {
        self.uuid = id
        ...
        self.avatar = avatar
        self.type = type
        self.normalHandle = normalHandle
        ...
        self.audioSessionPreferredSampleRate = audioSessionPreferredSampleRate
        self.audioSessionPreferredIOBufferDuration = audioSessionPreferredIOBufferDuration
    }
